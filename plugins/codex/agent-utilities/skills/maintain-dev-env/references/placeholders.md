...
| `<AGENTS_HOME>` | Agent marketplace or configuration home directory. |
| `<REPO_ROOT>` | Root of the plugin marketplace repository. |
| `<PROJECT_ROOT>` | Root of the project currently being prepared. |
| `<GLOBAL_MISE_CONFIG>` | Global mise config file. |
