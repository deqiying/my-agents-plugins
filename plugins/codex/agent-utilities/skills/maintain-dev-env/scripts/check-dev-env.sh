...
commands="brew mise java javac mvn mvnd node npm go rustc cargo python3 uv pnpm codex officecli opencli onesearch ast-grep bat delta difft doggo fd fzf gh jq just rg sd sqlite3 yq"
